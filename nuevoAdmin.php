	    	...
	    	<div class=" col-md-6 col-md-offset-3 ">
	    		...
	    		<div class="panel panel-default ">
					  <div class="panel-body">
					    <form role="form"  style="padding: 20px;" method="post" action="nuevoAdmin.php" enctype="multipart/form-data">
						<fieldset>
...
{	
	    ...
	    try {
	        ...
	        $stmt = $dbh->prepare("INSERT into usuario (usuario,contrasena,correo,tipo,imagen) values (:usuario,:contrasena,:correo,'1',:img) ");
