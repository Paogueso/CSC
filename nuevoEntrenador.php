	    	...
	    	<div class=" col-md-6 col-md-offset-3 ">
	    		...
	    		<div class="panel panel-default ">
					  <div class="panel-body">
					    <form role="form"  style="padding: 20px;" method="post" action="nuevoEntrenador.php" enctype="multipart/form-data">
							<fieldset>
					  ...
					  <div class="form-group has-feedback">
					    ...
					    <input type="text" class="form-control " id="fechanac" name="fechanac" placeholder="Fecha de Nacimiento" required>			    
					  </div>
					  <div class="form-group has-feedback">
...
{	
	    ...
	    try {
	        ...
	        $stmt = $dbh->prepare("INSERT into usuario (usuario, contrasena, correo, tipo,imagen) values (:usuario, :contrasena, :correo, '3',:img) ");
	        ...
	        $stmt = $dbh->prepare("INSERT into persona (Nombre,Apellido, Fecha_Nac, Deporte, Categoria, DUI, Telefono, usuario_idusuario) values (:Nombre, :Apellido, :Fecha_Nac, :Deporte, :Categoria, :DUI, :Telefono, :idusuario) ");
	        ...
	        $stmt->bindParam(':DUI', $dui, PDO::PARAM_STR, 50);
