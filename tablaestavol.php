...
<body role="document" ng-controller="TablaController3 as tabla"  ng-keydown="onKeyDown($event)" ng-keyup="onKeyUp($event)">
				...
				<table class="table table-hover">
			  			<thead>
							<tr>
								...
								<th>SAQUE</th><th>BLOQUEO</th><th>RECEP</th>
								<th>PUNTOS</th><th>SALVADAS</th>
							</tr>
						</thead>
						...
						<tbody>
							...
							<td ng-dblclick="suma(juga,'tiempo_juego',1);">{{juga.tiempo_juego}}</td>
                                <td ng-dblclick="suma(juga ,'Efect_Saque',1);">{{juga.Efect_Saque}}</td> 
                                <td ng-dblclick="suma(juga ,'Bloqueo',1);">{{juga.Bloqueo}}</td> 
                                <td ng-dblclick="suma(juga ,'Recepciones',1);">{{juga.Recepciones}}</td>
                                <td ng-dblclick="suma(juga ,'Puntos',1);">{{juga.Puntos}}</td> 
                                <td ng-dblclick="suma(juga ,'Salvadas',1);">{{juga.Salvadas}}</td> 
...
{	
	    ...
	    try {
	        ...
	        $stmt = $dbh->prepare("SELECT * FROM torneo WHERE Deporte='Voleibol' AND activo='1'");
